...
import io.wamsai1096.switchbuttom.R;


/**
 * SwitchButton.
 *
 * <br>Clone from implementation 'com.github.zcweng:switch-button:0.0.3@aar'
 *
 * @author wamsai1096 (wamsai1096@qq.com)
 */
public class SwitchButton extends View implements Checkable {
    ...
    public void setChecked(boolean checked) {
        ...
        toggle(enableEffect, false, false);
    }
     ...
     * @param animate
     */
    public void toggle(boolean animate, boolean fromUser) {
        toggle(animate, true, fromUser);
    }

    private void toggle(boolean animate, boolean broadcast, boolean fromUser) {
        if(!isEnabled()){return;}
     ...
     *
     */
    private void broadcastEvent(boolean fromUser) {
        if(onCheckedChangeListener != null){
            isEventBroadcast = true;
            onCheckedChangeListener.onCheckedChanged(this, isChecked(), fromUser);
        }
    ...
    public interface OnCheckedChangeListener{
        void onCheckedChanged(SwitchButton view, boolean isChecked, boolean fromUser);
    }
